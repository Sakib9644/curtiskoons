...
class BiomarkerSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $addNumeric('fasting_insulin', 'Fasting Insulin', 'uIU/mL', 'metabolic', [
            ['range' => [0, 1.9], 'delta' => 1],
            ['range' => [2, 6], 'delta' => -2],
        ...
        $addNumeric('lpa', 'Lp(a)', 'mg/dL', 'lipids', [
            ['range' => [0, 29], 'delta' => -1],
            ['range' => [30, 75], 'delta' => 0],
        ...
        $addNumeric('wbc_count', 'WBC Count', '×10⁹/L', 'blood', [
        ...
        $addGenetic('mthfr', 'MTHFR Gene', 'genetic', [
            'CC' => 0,
            'CT' => 0.5,
            'TT' => 1.5,
        ]);
