    ...
    <div class="side-app">
        <div class="main-container container-fluid">
            ...
            <div class="page-header d-flex justify-content-between align-items-center">
                <h1 class="page-title mb-0">Edit Health Goal</h1>
            ...
            <div class="row mt-4">
                <div class="col-lg-8 mx-auto">
                    <div class="card shadow-sm border-0">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('admin.health_goals.update', $healthGoal->id) }}">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="user_id" id="user_id"
                                        ...
                                        @foreach (\App\Models\User::select('id', 'name', 'email')->withoutRole('admin')->get() as $user)
                                            <option value="{{ $user->id }}" {{ $user->id == old('user_id', $healthGoal->user_id) ? 'selected' : '' }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="goal" id="goal" placeholder="Enter goal"
                                        ...
                                        value="{{ old('goal', $healthGoal->goal) }}" required>
                                    @error('goal')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="methods" id="methods" rows="5"
                                        class="form-control summernote @error('methods') is-invalid @enderror"
                                        placeholder="Describe methods">{{ old('methods', $healthGoal->methods) }}</textarea>
                                    @error('methods')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.1" name="timeline_years" id="timeline_years"
                                        ...
                                        value="{{ old('timeline_years', $healthGoal->timeline_years) }}">
                                ...
                                <div class="d-grid mt-4">
                                    <button type="submit" class="btn btn-success btn-lg">
                                        <i class="feather-save me-2"></i> Update Health Goal
                                    </button>
                                </div>
