                        ...
                        <div class="card post-sales-main">
                            ...
                            <div class="card-body border-0">
                                <form class="form form-horizontal" method="POST"
                                    action="{{ route('admin.health_goals.update', $healthGoal->id) }}">
                                    @csrf
                                    @method('PUT')
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    id="goal" placeholder="Enter goal"
                                                    value="{{ old('goal', $healthGoal->goal) }}">
                                                @error('goal')
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control summernote @error('methods') is-invalid @enderror" name="methods" id="methods"
                                                    placeholder="Enter methods" rows="4">{{ old('methods', $healthGoal->methods) }}</textarea>
                                                @error('methods')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
