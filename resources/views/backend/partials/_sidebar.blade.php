    ...
    <div class="app-sidebar" style="overflow: scroll">
        ...
        <div class="main-sidemenu">
            ...
            <ul class="side-menu mt-2">
                ...
                <li class="slide">
                    <a class="side-menu__item {{ request()->routeIs('admin.biomarker.*') ? 'has-link active' : '' }}"
                        href="{{ route('admin.biomarker.index') }}">
                        <i class="fa-solid fa-dna side-menu__icon"></i>
                        <span class="side-menu__label">Blue Age Biomarkers</span>
                    </a>
                </li>
                ...
                <li class="slide {{ env('ACCESS') === false ? 'd-none' : '' }}">
                    ...
                    <ul class="slide-menu">
                        <li><a href="{{ route('admin.users.index') }}"
                                class="slide-item {{ request()->routeIs('admin.users.*') ? 'active' : '' }}">User</a>
                        </li>
                        @if (auth()->user()->hasRole('admin'))
                            <li><a href="{{ route('admin.roles.index') }}"
                                    class="slide-item {{ request()->routeIs('admin.roles.*') ? 'active' : '' }}">Role</a>
                            </li>
                            <li><a href="{{ route('admin.permissions.index') }}"
                                    class="slide-item {{ request()->routeIs('admin.permissions.*') ? 'active' : '' }}">Permission</a>
                            </li>
                        @endif
                    </ul>
                </li>
